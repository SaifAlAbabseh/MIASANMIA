                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (isset($_REQUEST) && isset($_REQUEST["with"])) {
                                    echo "<img src='showImg.php?u=" . $_REQUEST["with"] . "' width='50px' height='50px' style='border-radius:50%'/>";
                                }
                                ?>
                            </td>
                            <td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#sendButton").click(function() {
                ...
                xmlhttp2.open("GET", "sendMessage.php?message=" + message + "&with=" + towho + "&lastI=" + oldpos + "&tname=" + tname, true);
                xmlhttp2.send();
            });
                        ...
                        if (res != "nomore" && res != "error" && !res.includes("*")) {
                            ...
                            if (oldpos != pos) {
                                ...
                                if (lastwho == you) {
                                    ...
                                    newrow2.setAttribute("style", "text-align:right");
                                    newrow1.innerHTML = "<td style='color:yellow'>From : " + you + "</td>";
                                    newrow2.innerHTML = "<td style='color:white'>" + mess + "</td>";
                                } else {
                                    newrow1.setAttribute("style", "text-align:left");
                                    newrow2.setAttribute("style", "text-align:left");
