<?php
session_start();
if (isset($_REQUEST) && isset($_SESSION) && isset($_SESSION["who"])) {
    require_once("DB.php");
                ...
                if (mysqli_num_rows($result2)) {
                    while ($row2 = mysqli_fetch_row($result2)) {
                        ...
                        echo "
                                    ...
                                    <tr>
                                        <td><img src='showImg.php?u=" . $row2[0] . "' width='50px' height='50px' style='border-radius:50%'/> <sup>" . $ava . "</sup></td>
                                        <td><h2 style='color:white'>" . $row2[0] . "</h2></td>
                                        <td>
                                            <a href='WithFriend.php?with=" . $row2[0] . "' class='link'>Chat</a>
                                        </td>
                                        <td>
                                            <a href='delFriend.php?name=" . $row2[0] . "' class='link'>Delete</a>
                                        </td>
                                    </tr>
