...
public class MainActivity extends AppCompatActivity {
    ...
    public class conn extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            String link="http://192.168.1.17/All_Chat/Mobile/checkInfoForLogin.php?check=fromMobile1090&username="+username+"&password="+password;
            String link2="http://192.168.1.17/All_Chat/Mobile/updateAvailability.php?check=fromMobile1090&username="+username+"&password="+password+"&which=2";
            try{
